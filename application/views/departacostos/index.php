...
<div class="container-fluid">
   <div class="panel panel-default">
        ...
        <div class="panel-body">
           <table id="departamentocostos" class="stripe row-border responsive nowrap" cellspacing="0" width="100%">
        ...
        <div class="panel-footer">
            <a href="<?php echo base_url();?>catalogos/DeptosCostos/agregar" class="btn btn-success btn-lg" role="button"><span class="glyphicon glyphicon-plus"></span> Agregar departamento costos</a>
        </div>
   </div>
