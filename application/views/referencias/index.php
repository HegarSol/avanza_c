...
<div class="container-fluid">
   <div class="panel panel-default">
        ...
        <div class="panel-body">
           <table id="referencias" class="stripe row-border responsive nowrap" cellspacing="0" width="100%">
        ...
        <div class="panel-footer">
            <a href="<?php echo base_url();?>catalogos/Referencias/agregar" class="btn btn-success btn-lg" role="button"><span class="glyphicon glyphicon-plus"></span> Agregar referencia para control de gastos</a>
        </div>
   </div>
